"""
Sign Language Recognition with MediaPipe Hand Detection
Uses MediaPipe for reliable hand detection and tracking
"""
...
def main():
    ...
    print("="*70)
    print("Sign Language Recognition with MediaPipe")
    print("="*70)
    print("\nFeatures:")
    print("  ✓ MediaPipe hand detection and tracking")
    print("  ✓ 21-point hand landmarks")
    print("  ✓ Real-time sign language recognition")
    print("  ✓ Automatic hand cropping")
    print("\nLoading models...")
    ...
    with tf_v1.Session() as sess:
        ...
        while True:
            ...
            # Model info
            cv2.putText(frame, "Detection: MediaPipe", (10, 95), 
            ...
            cv2.imshow('Sign Language Recognition - MediaPipe', frame)
